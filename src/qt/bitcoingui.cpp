...
void BitcoinGUI::createActions(bool fIsTestnet)
{
    ...
    scanPaperWalletAction = new QAction(QIcon(":/icons/print"), tr("&Scan paper wallets"), this);
    scanPaperWalletAction->setStatusTip(tr("Scan paper wallets"));
    ...
    if(walletFrame)
    {
        ...
        connect(scanPaperWalletAction, SIGNAL(triggered()), walletFrame, SLOT(scanPaperWallets()));
    }
#endif
}
...
void BitcoinGUI::createMenuBar()
{
    ...
    if(walletFrame)
    {
        ...
        file->addAction(scanPaperWalletAction);
        file->addSeparator();
...
void BitcoinGUI::setWalletActionsEnabled(bool enabled)
{
    ...
    scanPaperWalletAction->setEnabled(enabled);
}
